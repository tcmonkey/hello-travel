...
public interface IndexJobRepository {
     ...
     * @return 当前操作的业务结果
     */
    IndexJobAggregate findById(Long id);
     ...
     * @return 当前操作的业务结果
     */
    List<IndexJobAggregate> query(QueryValue queryValue);
     ...
     * @return 当前操作的业务结果
     */
    Boolean save(IndexJobAggregate aggregate);
