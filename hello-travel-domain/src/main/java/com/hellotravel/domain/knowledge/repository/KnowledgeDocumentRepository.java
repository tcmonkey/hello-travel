...
/**
 * KnowledgeDocument聚合持久化端口；查询条件由可信业务生成。
 *
 * @author AIGenerator
 */
public interface KnowledgeDocumentRepository {
     ...
     * @return 当前操作的业务结果
     */
    KnowledgeDocumentAggregate findById(Long id);
     ...
     * @return 当前操作的业务结果
     */
    List<KnowledgeDocumentAggregate> query(QueryValue queryValue);
     ...
     * @return 当前操作的业务结果
     */
    Boolean save(KnowledgeDocumentAggregate aggregate);
