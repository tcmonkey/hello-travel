...
/**
 * Conversation聚合持久化端口；查询条件由可信业务生成。
 *
 * @author AIGenerator
 */
public interface ConversationRepository {
     ...
     * @return 当前操作的业务结果
     */
    ConversationAggregate findById(Long id);
     ...
     * @return 当前操作的业务结果
     */
    List<ConversationAggregate> query(QueryValue queryValue);
     ...
     * @return 当前操作的业务结果
     */
    Boolean save(ConversationAggregate aggregate);
