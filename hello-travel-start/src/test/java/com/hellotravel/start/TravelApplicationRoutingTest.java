 ...
 * @author AIGenerator
 */
class TravelApplicationRoutingTest {
    ...
    void preservesApplicationFailureClassificationAndMarksClaimedRun() {
        ...
        TravelDialogueFlow dialogue = mock(TravelDialogueFlow.class);
        ...
        var application = new TravelApplication(
                execution,
                contextService,
                intentAdaptor,
                new TravelIntentAssembler(),
                dialogue,
                planning,
                new TravelApplicationAssembler());
