...
import com.hellotravel.application.knowledge.assembler.KnowledgeWriteApplicationAssembler;
...
public final class KnowledgeWrites {
    ...
    private final KnowledgeWriteApplicationAssembler knowledgeWriteApplicationAssembler;

    public KnowledgeWrites(
            KnowledgeDomainService service,
            KnowledgeWriteApplicationAssembler knowledgeWriteApplicationAssembler) {
        this.service = service;
        this.knowledgeWriteApplicationAssembler = knowledgeWriteApplicationAssembler;
    }
    ...
    public Boolean saveKnowledgeDocument(KnowledgeDocumentAggregate aggregate) {
        ...
        var param = knowledgeWriteApplicationAssembler.write(aggregate);
