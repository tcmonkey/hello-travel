 ...
 */
@Component
public final class KnowledgeApplicationAssembler {
     ...
     * @author AIGenerator
     */
    public DocumentResult document(KnowledgeDocumentEntity entity, boolean full) {
     ...
     * @author AIGenerator
     */
    public KnowledgeResult single(KnowledgeDocumentEntity entity, boolean full) {
        return new KnowledgeResult(java.util.List.of(document(entity, full)), 0, false);
    }
