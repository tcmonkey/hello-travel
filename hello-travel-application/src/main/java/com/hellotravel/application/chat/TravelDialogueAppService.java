...
import com.hellotravel.application.chat.assembler.TravelDialogueAppAssembler;
 ...
 */
@Component
public final class TravelDialogueAppService {

    private final TravelDialogueAdaptor travelDialogueAdaptor;
    private final TravelDialogueAppAssembler travelDialogueAppAssembler;
    ...
    public TravelDialogueAppService(
            TravelDialogueAdaptor travelDialogueAdaptor,
            TravelDialogueAppAssembler travelDialogueAppAssembler,
        ...
        this.travelDialogueAppAssembler = travelDialogueAppAssembler;
    ...
    public Result<TravelConversationContext> answer(
        ...
        try {
            ...
            var response = travelDialogueAdaptor.answer(
                    travelDialogueAppAssembler.command(
                            context,
                            text -> {
