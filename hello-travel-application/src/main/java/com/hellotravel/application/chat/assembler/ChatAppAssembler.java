...
import com.hellotravel.application.chat.result.ConversationAppResult;
import com.hellotravel.application.chat.result.MessageAppResult;
import com.hellotravel.application.chat.result.RunAppResult;
 ...
 */
@Component
public final class ChatAppAssembler {
     ...
     * @return 当前操作的业务结果
     */
    public ConversationAppResult conversation(ConversationEntity entity) {
        return new ConversationAppResult(
                entity.publicId(),
                entity.title(),
                entity.version(),
                entity.historyEpoch(),
     ...
     * @return 当前操作的业务结果
     */
    public MessageAppResult message(MessageEntity entity) {
        return new MessageAppResult(
                entity.publicId(),
                entity.messageSeq(),
                entity.role(),
                entity.status(),
     ...
     * @return 当前操作的业务结果
     */
    public RunAppResult run(ChatRunEntity entity, String conversationId) {
        return new RunAppResult(
                entity.publicId(),
                conversationId,
                entity.status(),
                entity.errorCode(),
     ...
     * @author AIGenerator
     */
    public ChatAppResult bootstrap(long max, long sync) {
        return new ChatAppResult(
     ...
     * @author AIGenerator
     */
    public ChatAppResult tabs(java.util.List<ConversationAggregate> rows, ChatCommand command) {
     ...
     * @author AIGenerator
     */
    public ChatAppResult changed(ConversationEntity entity, UserAccountEntity account) {
        return new ChatAppResult(
     ...
     * @author AIGenerator
     */
    public ChatAppResult runSnapshot(
     ...
     * @author AIGenerator
     */
    public ChatAppResult completed() {
        return new ChatAppResult(
