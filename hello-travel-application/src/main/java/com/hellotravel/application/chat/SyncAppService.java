...
import com.hellotravel.application.chat.assembler.SyncAppAssembler;
 ...
 */
@Service
public final class SyncAppService {

    private final SyncEventRepository syncEventRepository;
    private final UserAccountRepository userAccountRepository;
    private final SyncAppAssembler syncAppAssembler;

    public SyncAppService(
            SyncEventRepository syncEventRepository,
            UserAccountRepository userAccountRepository,
            SyncAppAssembler syncAppAssembler) {
        this.syncEventRepository = syncEventRepository;
        this.userAccountRepository = userAccountRepository;
        this.syncAppAssembler = syncAppAssembler;
    }
     ...
     */
    public Result<SyncAppResult> synchronize(SyncCommand syncCommand) {
        try {
            ...
            // 2. 按可信内部标识读取账号当前快照。
            long high =
                    userAccountRepository.findById(syncCommand.userId()).entity().syncSeq();
            ...
            return Result.success(syncAppAssembler.page(rows, high));
