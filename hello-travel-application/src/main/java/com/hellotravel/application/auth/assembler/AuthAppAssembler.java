 ...
 */
@Component
public final class AuthAppAssembler {
     ...
     * @author AIGenerator
     */
    public AuthAppResult challenge(String challengeId) {
        return new AuthAppResult(null, null, null, null, null, null, null, null, challengeId);
    }
     ...
     * @author AIGenerator
     */
    public AuthAppResult account(UserAccountEntity account) {
     ...
     * @author AIGenerator
     */
    public AuthAppResult checked(UserAccountEntity account, LoginSessionEntity session) {
     ...
     * @author AIGenerator
     */
    public AuthAppResult session(
            UserAccountEntity account,
            LoginSessionEntity session,
            String access,
            String refresh,
            String csrf) {
        return new AuthAppResult(
                account.id(),
                account.publicId(),
