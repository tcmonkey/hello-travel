...
public final class ChatAssembler {
     ...
     * @author AIGenerator
     */
    public ConversationResponse conversation(ConversationAppResult value) {
     ...
     * @author AIGenerator
     */
    public MessageResponse message(MessageAppResult value) {
     ...
     * @author AIGenerator
     */
    public RunResponse run(RunAppResult value) {
        return value == null
                ? null
                : new RunResponse(
                        value.id(),
     ...
     * @author AIGenerator
     */
    public ChatResponse toResponse(ChatAppResult result) {
