 ...
 */
@Component
public final class LangChain4jTravelDialogueOutAdaptor implements TravelDialogueAdaptor {
    ...
    public LangChain4jTravelDialogueOutAdaptor(
            TravelDialogueAiService travelDialogueAiService,
            ChatContextPolicy chatContextPolicy,
            ChatModelOutputConverter chatModelOutputConverter,
    ...
    public Result<ChatModelDO> answer(TravelDialogueCommand travelDialogueCommand) {
        try {
            ...
            return Result.success(chatModelOutputConverter.response(
