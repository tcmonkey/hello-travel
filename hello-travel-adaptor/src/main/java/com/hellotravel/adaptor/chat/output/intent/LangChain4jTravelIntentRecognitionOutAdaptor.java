 ...
 */
@Component
public final class LangChain4jTravelIntentRecognitionOutAdaptor
        implements TravelIntentRecognitionAdaptor {

    private final TravelIntentAiService travelIntentAiService;
    private final ChatContextPolicy chatContextPolicy;

    public LangChain4jTravelIntentRecognitionOutAdaptor(
