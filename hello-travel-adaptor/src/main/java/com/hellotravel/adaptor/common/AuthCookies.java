...
public final class AuthCookies {
    ...
    private String sign(String key) {
        ...
        var result = security.process(securityCommandAppAssembler.signDevice(key));
     ...
     * @author AIGenerator
     */
    public void writeSession(HttpServletResponse response, AuthCommand command, AuthAppResult result) {
