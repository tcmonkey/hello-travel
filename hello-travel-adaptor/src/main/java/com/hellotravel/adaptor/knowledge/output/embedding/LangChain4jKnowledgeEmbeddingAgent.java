package com.hellotravel.adaptor.knowledge.output.embedding;

import com.hellotravel.adaptor.exception.AdaptorErrorCode;
import com.hellotravel.adaptor.knowledge.output.embedding.converter.KnowledgeEmbeddingConverter;
 ...
 */
@Component
public final class LangChain4jKnowledgeEmbeddingAgent implements KnowledgeEmbeddingAgent {

    private final EmbeddingModel embeddingModel;
    private final KnowledgeEmbeddingConverter converter;

    public LangChain4jKnowledgeEmbeddingAgent(
